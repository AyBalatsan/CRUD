...
interface AllDataProps {
  listUsers: Array<iListUser>
}

const MainPage: FC<AllDataProps>  = ({listUsers}) => {

  let storageUsers = localStorage.getItem('Users') !== null ? JSON.parse(String(localStorage.getItem('Users'))) : listUsers
  
  const [users, setUsers] = useState<iListUser[]>(storageUsers)
